# Verdict · 20260723T035828Z_fixture-B
...
- **Commit**: 59185807129ad2d9e5c7e83026edf72be8362bd0
...
- `duration_under_hard_threshold` (operational) — duration_ms=240964 hard=240000
...
- `duration_under_soft_threshold` (operational) — duration_ms=240964 soft=120000
- `quote_integrity_checker_executed` (quote_integrity) — mode=telemetry_only verdict=blocked_no_report
- `quote_integrity_summary_written` (quote_integrity) — .agent/regression_runs/20260723T035828Z_fixture-B/quote_integrity_summary.json

## Quote integrity

- **Verdict**: **BLOCKED_NO_REPORT**
- **Summary**: `.agent/regression_runs/20260723T035828Z_fixture-B/quote_integrity_summary.json`
- **Red reasons**: 0
- **Amber reasons**: 0
...
- Committed: `.agent/regression_runs/20260723T035828Z_fixture-B/{metadata.json,structural_checks.json,verdict.md,quote_integrity_summary.json}`
- Scratchpad: `/var/folders/xx/ypnl5f2n0y7b48w_pgxyhqt80000gn/T/acr-regression-runs/20260723T035828Z_fixture-B/report.md`, `/var/folders/xx/ypnl5f2n0y7b48w_pgxyhqt80000gn/T/acr-regression-runs/20260723T035828Z_fixture-B/report.png`
